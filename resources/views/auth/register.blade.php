                                            ...
                                            <div class="card">
                                                <form method="post" action="{{ route('user.register') }}"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <h5 class="text-primary mb-3">Personal <span
                                                        ...
                                                        <!-- Contact Information -->
                                                        <h5 class="text-primary mb-3">Contact <span
                                                                class="text-secondary">Information</span></h5>
                                                        <div class="form-row">
                                                            <div class="col-md-4 mb-3">
                                                                <label
                                                                    class="text-primary font-weight-bold">Country</label>
                                                                <select name="country" class="form-control"
                                                                    id="country">
                                                                    <option value="">Select</option>
                                                                    <!-- Add countries dynamically if needed -->
                                                                </select>
                                                                @error('country')
                                                                <div class="alert alert-danger mt-2">{{ $message }}
                                                                </div>
                                                            ...
                                                            <div class="col-md-4 mb-3">
                                                                <label
                                                                    class="text-primary font-weight-bold">City</label>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-md-3 mb-3">
                                                                <input name="complete_acount" type="submit"
