                    ...
                    <section class='sub-hero hero--image js-hero--image' aria-label="Hero Area">
                        <div class='image-hero js-hero-image-bg'>
                            <div class='hero-image-bg main-hero-background main-hero-background--home hero-image-bg--gradient hero-image-bg--gradient-10'
                                style='background-image:url("templates/bank-pro/why-citadel-images/3217%20%20Why%20Citadel%20ContentAboutUsv30.jpg"); transform:translateY(0px);'>
                            </div>
                        </div>
                        <div class='sub-hero-content l-contain'>
                            <div class='sub-hero-content-inner'>
                                <p class="sub-hero__title mb-1">Who We Are</p>
                                <p class='sub-hero__teaser p'>Hi there. We're First. We promise to help you live your
                ...
                <div class='bg-white u-pos-relative l-z-index-100 u-cf'>
                            ...
                            <div class="js-tiles-container">
                                <div class="tiles__inner js-tile-group">
                                    <a class="tile js-tile tile--link" href="#">
                                        <h3 class="tile__heading">Why Choose First?</h3>
                                    ...
                                    <a class="tile js-tile tile--link" href="#">
                                        ...
                                        <p class="tile__body">Read through First&rsquo;s annual reports, which
                    ...
                    <div class='l-join-cta content-nav-section' data-short-name='CTA'>
                        <section class="join-cta join-cta--primary" aria-label="Join First">
                            <div class="join-cta-content l-contain u-align-center">
                                ...
                                <p style="color:#fff">We’ve built a different kind of high street bank. A bank with
                                    stores that are open when it suits you, where you can walk in without an appointment
                                    and leave with a working account, debit card and all. A bank that tells you exactly
                                    what you’re getting, in language that actually makes sense. A bank that puts you
                                    first.</p>
                            </div>
                        </section>
                    </div>
                    <div id="getstarted">
                        <div class="quick-bar__wrap l-contain">
                            ...
                            <div class='quick-bar'>
                                <a href="#" class="quick-bar__item" rel="noopener noreferrer" target="_blank"> <img
                    ...
                    <div class='l-join-cta content-nav-section' data-short-name='CTA'>
                        <section class="join-cta join-cta--secondary join-cta--ms" aria-label="Join First">
                            <div class="join-cta-content l-contain u-align-center">
                                <h2 class="join-cta__title ">Find a First location near you.</h2>
                                <a href="#" onClick="alert('Unable to determine your location. Please contact support')"
                                    class="join-cta__link" title="Search tool to find First Branches and ATMs.">Find a
                                    Branch</a>
                            </div>
                        </section>
                    </div>
